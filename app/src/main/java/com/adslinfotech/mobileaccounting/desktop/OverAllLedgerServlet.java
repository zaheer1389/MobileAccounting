...
public class OverAllLedgerServlet extends HttpServlet {
  ...
  public OverAllLedgerServlet(Context context, String category) {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    if (this.mType == null || this.mType.equalsIgnoreCase("")) {
      this.mType = "Individual";
    }
    if (!(this.mType == null || this.mType.equalsIgnoreCase(""))) {
      list = this.mType.equalsIgnoreCase("All") ? this.mFetchData.getCategoryBalance(null) : this.mFetchData.getCategoryBalance(this.mType);
    }
    double doubleCRTotal = 0.0d;
    double doubleDRTotal = 0.0d;
    StringBuilder sb = new StringBuilder();
    sb.append("<!DOCTYPE html><html lang='en' class='no-js'>");
    sb.append("<head><title>Simple Accounting - Category wise Balance Summary</title>");
    ...
    sb.append("</header><div class='component'><h2>Simple Accounting - Category wise Balance Summary <span style='font-weight: normal;font-style: italic;'> by ADSL Infotech</span></h2>");
    ...
    sb.append("<table>\n");
    sb.append("<th>SNo</th><th>Account</th><th>Debit</th><th>Credit</th><th>Balance</th>");
    int i = 1;
    Iterator it = list.iterator();
    while (it.hasNext()) {
      Transaction dao = (Transaction) it.next();
      String strAccount = dao.getAccName();
      double debit = dao.getDebitAmount();
      double credit = dao.getCraditAmount();
      String totalbalance;
      int i2;
      if (credit > debit) {
        totalbalance = this.newFormat.format(credit - debit) + " Cr";
        sb.append("<tr>\n");
        i2 = i + 1;
        sb.append("<td>" + i + "</td><td>" + strAccount + "</td><td class='right'>" + this.newFormat.format(dao.getDebitAmount()) + "</td><td class='right'>" + this.newFormat.format(dao.getCraditAmount()) + "</td><td class='right' style= background-color:#ff0000>" + totalbalance + "</td>");
        sb.append("</tr>\n");
        doubleCRTotal += credit;
        doubleDRTotal += debit;
        i = i2;
      } else if (debit > credit) {
        totalbalance = this.newFormat.format(debit - credit) + " Dr";
        sb.append("<tr>\n");
        i2 = i + 1;
        sb.append("<td>" + i + "</td><td>" + strAccount + "</td><td class='right'>" + this.newFormat.format(dao.getDebitAmount()) + "</td><td class='right'>" + this.newFormat.format(dao.getCraditAmount()) + "</td><td class='right' style= background-color:#551076>" + totalbalance + "</td>");
        sb.append("</tr>\n");
        doubleCRTotal += credit;
        doubleDRTotal += debit;
        i = i2;
    ...
    if (doubleCRTotal > doubleDRTotal) {
      sb.append("<td colspan='2' class='right'>Total:</td><td class='right'style= background-color:#551076>" + this.newFormat.format(doubleDRTotal) + "</td><td class='right' style= background-color:#ff0000>" + this.newFormat.format(doubleCRTotal) + "</td><td  class='right' style= background-color:#ff0000><b>" + (this.newFormat.format(doubleCRTotal - doubleDRTotal) + " Cr") + "</b></td>");
      sb.append("</tr></tfoot>\n");
      sb.append("</table></body></html>");
    } else if (doubleDRTotal > doubleCRTotal) {
      sb.append("<td colspan='2' class='right'>Total:</td><td class='right'style= background-color:#551076>" + this.newFormat.format(doubleDRTotal) + "</td><td class='right' style= background-color:#ff0000>" + this.newFormat.format(doubleCRTotal) + "</td><td  class='right' style= background-color:#551076><b>" + (this.newFormat.format(doubleDRTotal - doubleCRTotal) + " Dr") + "</b></td>");
      sb.append("</tr></tfoot>\n");
      sb.append("</table></body></html>");
    } else {
      sb.append("<td colspan='2' class='right'>Total:</td><td class='right'style= background-color:#551076>" + this.newFormat.format(doubleDRTotal) + "</td><td class='right' style= background-color:#ff0000>" + this.newFormat.format(doubleCRTotal) + "</td><td  class='right'><b>" + "0.00" + "</b></td>");
      sb.append("</tr></tfoot>\n");
      sb.append("</table></body></html>");
    }
